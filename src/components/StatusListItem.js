  ...
  return (
    <article onClick={handleItemClick} >
      <ul>
        ...
        <li>{"Priority: " + PRIORITY_LIST[props.statusItem.status_repair_priority]}</li>
      </ul>
    </article>
  )
}
...
// {"status_id":0,"status_tail_number":15000000,"aircraft_id":0,"aircraft_name":"A-10","base_id":0,"base_name":"Davis–Monthan AFB","status_is_flyable":true,"status_description":"BRRRT","status_repair_priority":3,"status_last_updated":"2021-07-29"}